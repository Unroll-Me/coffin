...
(function() {
  ...
  CloudFormationTemplateContext = (function() {
    ...
    CloudFormationTemplateContext.prototype.Regex = function(regex) {
      return regex.toString().replace(/^\/|\/$/g, '');
    };

    CloudFormationTemplateContext.prototype.Tag = function(key, val, propagate) {
      var result;
      result = {};
      if (propagate === true) {
    ...
    CloudFormationTemplateContext.prototype.Command = function() {
      var args;
      args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
      return {
        command: this.Join('', args),
        cwd: '~',
        ignoreErrors: false
      };
    };

    CloudFormationTemplateContext.prototype.S3 = function() {
      var args;
      args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
